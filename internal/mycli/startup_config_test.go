...
func TestStartupConfigVariablesAreReadOnly(t *testing.T) {
	...
	for _, tt := range []struct {
		...
		{varName: "CLI_CA_CERT_FILE", value: "/tmp/ca.pem"},
		{varName: "CLI_CLIENT_CERT_FILE", value: "/tmp/client.pem"},
		{varName: "CLI_CLIENT_CERT_KEY", value: "/tmp/client.key"},
		{varName: "CLI_WITHOUT_AUTHENTICATION", value: "TRUE"},
