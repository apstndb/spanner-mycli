...
| SHOW DDLs                                                                   | `SHOW DDLS;`                                                                                               |                                                                                                                                                                                                                         |
| Export database DDL and data as SQL statements                              | `DUMP DATABASE;`                                                                                           | Exports DDL plus BASE TABLE data from the default schema and named schemas. Views and synonyms are omitted from data. Requires spanner.databases.getDdl.                                                                |
...
| Export specific tables as SQL INSERT statements                             | `DUMP TABLES <table1> [, <table2>, ...];`                                                                  | Table names are [<schema>.]<table>. Data only; no DDL. Requires spanner.databases.getDdl only when a selected interleaved child has another selected table whose name matches the catalog parent basename.              |
