...
Flags:
  ...
  -v, --verbose                                Display verbose output.
      ...
      --param=KEY=VALUE                        Set query parameters, it can be literal or type(EXPLAIN/DESCRIBE only).
                                               Names are case-insensitive; conflicting case aliases are rejected. e.g.
                                               --param="p1='string_value'" --param=p2=FLOAT64
...
| Show query parameters                                                       | `SHOW PARAMS;`                                                                                             | Displays the stored spelling of each parameter.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
(same kind and memefish `SQL()` rendering) share one logical value.
