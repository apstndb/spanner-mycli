...
| Show EXPLAIN or EXPLAIN ANALYZE of the last query without execution | `EXPLAIN [ANALYZE] [FORMAT=<format>] [WIDTH=<width>] LAST QUERY;`                                          | Options can be in any order. Spaces are not allowed before or after the `=`.                                                                                               |
