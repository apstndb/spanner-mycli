...
3. **Document the source**: 
   - For --help: `<!-- Content from ./tmp/help_clean.txt. Generated by: script -q ./tmp/help_output.txt sh -c "stty cols 200; go run . --help" && sed '1s/^.\{2\}//' ./tmp/help_output.txt > ./tmp/help_clean.txt -->`
...
# <!-- Content from ./tmp/help_clean.txt. Generated by: script -q ./tmp/help_output.txt sh -c "stty cols 200; go run . --help" && sed '1s/^.\{2\}//' ./tmp/help_output.txt > ./tmp/help_clean.txt -->
# ```
# [OLD CONTENT]
# ```
# 
