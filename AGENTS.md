...
- This module targets Go 1.26. Use language features and standard-library APIs available through Go 1.26 when touching nearby code, while keeping modernization changes scoped.
